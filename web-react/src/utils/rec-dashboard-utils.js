...
function getStateByTeamCity(city) {
  switch (city) {
    case 'los angeles':
      return stateNames.CA;
    case 'milwaukee':
      return stateNames.WI;
    case 'minneapolis':
      return stateNames.MN;
    case 'oklahoma city':
      return stateNames.OK;
    case 'denver':
      return stateNames.CO;
    case 'boston':
      return stateNames.MA;
    case 'memphis':
      return stateNames.TN;
    case 'indianapolis':
      return stateNames.IN;
    default:
      return 'Unknown';
  }
}
...
const recDashboardUtils = {
  getStateByTeamCity,
  getStateByZip,
};

export default recDashboardUtils;
